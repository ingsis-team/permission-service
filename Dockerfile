# Use the Gradle image with JDK 21 and 22 to build and run the application.
...
ENTRYPOINT ["java","-jar","-javaagent:/usr/local/newrelic/newrelic.jar","/home/gradle/src/build/libs/permission-service-0.0.1-SNAPSHOT.jar"]
